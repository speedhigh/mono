<template>
  <section class="mt-[4.38rem] w-full h-[54.38rem] bg-[#F8FBFF] pt-[4.75rem] pb-24 relative">
    <div class="relative w-[1200px] mx-auto">
      ...
      <div class="mt-12 grid grid-cols-3 gap-x-[2.63rem] gap-y-10">
        ...
        >
          ...
          <div class="absolute bottom-0 inset-x-0 h-[50px] rounded-b-lg bg-[rgba(255,255,255,0.5)] w-full flex items-center px-3 space-x-2.5">
    ...
    >
      <div class="w-full h-full bg-[#F8FBFF]" style="clip-path: polygon(100% 2%, 90% 98%, 3% 40%)" />
    </div>
    <!-- star2 -->
    <div 
    ...
    >
      <div class="w-full h-full bg-[#F8FBFF]" style="clip-path: polygon(0% 0%, 92% 28%,18% 92%)" />
    </div>
    <!-- star3 -->
    <div 
    ...
    >
      <div class="w-full h-full bg-[#F8FBFF]" style="clip-path: polygon(74% 8%, 100% 100%, 8% 84%)" />
    </div>
    <!-- star4 -->
    <div 
    ...
    >
      <div class="w-full h-full bg-[#F8FBFF]" style="clip-path: polygon(10% 0%, 90% 5%, 40% 82%)" />
    </div>
    <!-- star5 -->
    <div 
      ...
      style="clip-path: polygon(100% 0%, 90% 100%, 0% 40%)"
    >
      <div class="w-full h-full bg-[#F8FBFF]" style="clip-path: polygon(100% 2%, 90% 96%, 4% 40%)" />
    </div>
  </section>
</template>
